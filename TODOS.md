...
- [~] **P3b-b — interfaces terminal adaptatives** : bannieres + `manager_ui_section_line` generalises ; pathman/doctorman ; `processman` + `tui_menu_height` ; `make test-tui-compact`. **Reste** : `tui_truncate`, pagination menus longs, replay manuel `*man help` avec `COLUMNS=60` (EXT-002).
