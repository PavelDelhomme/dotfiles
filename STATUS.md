...
- **Vérifier la phase 2** : `grep -E 'Matrice sous-commandes|échec:|Shells ignorés' …/test_output.log | tail -20` — attendu : `échecs: 0` et `✅ Matrice sous-commandes : OK`. Les shells demandés mais non installés sont désormais **ignorés explicitement** (pas comptés en échec).
