...
- **`menu/`** : anciens menus shell globaux. Ne pas l'etendre pour les managers ; voir [`docs/architecture/UI_MENU_RESTRUCTURE.md`](../docs/architecture/UI_MENU_RESTRUCTURE.md).
