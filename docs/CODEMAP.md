# Arborescence code (CODEMAP)

> **Hub doc** : [`INDEX.md`](INDEX.md) · **Carte doc** : [`STRUCTURE.md`](STRUCTURE.md) · **Tests** : [`TESTS.md`](TESTS.md) · **Erreurs** : [`ERRORS.md`](ERRORS.md) · **Statut** : [`../STATUS.md`](../STATUS.md) · **Tâches** : [`../TODOS.md`](../TODOS.md)
>
> **Rôle de ce fichier** : **arborescence du code** (scripts, fonctions zsh, managers, utilitaires). Pour la **carte de la documentation**, voir [`STRUCTURE.md`](STRUCTURE.md). Pour comprendre l’**architecture cible** (managers / shells / `dotcli`), voir [`architecture/ARCHITECTURE.md`](architecture/ARCHITECTURE.md) et [`platform/UNIFIED_PLATFORM_ROADMAP.md`](platform/UNIFIED_PLATFORM_ROADMAP.md).
