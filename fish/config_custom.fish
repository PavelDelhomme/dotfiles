...
# Charger depuis la nouvelle structure hybride (adapters)
load_manager "pathman" "$DOTFILES_DIR/shells/fish/adapters/pathman.fish" "PATHMAN"
load_manager "manman" "$DOTFILES_DIR/shells/fish/adapters/manman.fish" "MANMAN"
load_manager "searchman" "$DOTFILES_DIR/shells/fish/adapters/searchman.fish" "SEARCHMAN"
load_manager "aliaman" "$DOTFILES_DIR/shells/fish/adapters/aliaman.fish" "ALIAMAN"
load_manager "installman" "$DOTFILES_DIR/shells/fish/adapters/installman.fish" "INSTALLMAN"
load_manager "configman" "$DOTFILES_DIR/shells/fish/adapters/configman.fish" "CONFIGMAN"
load_manager "gitman" "$DOTFILES_DIR/shells/fish/adapters/gitman.fish" "GITMAN"
load_manager "fileman" "$DOTFILES_DIR/shells/fish/adapters/fileman.fish" "FILEMAN"
load_manager "helpman" "$DOTFILES_DIR/shells/fish/adapters/helpman.fish" "HELPMAN"
